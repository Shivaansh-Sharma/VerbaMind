...
const words = ["Word Count", "Language Detection", "Text Summarization", "Topic Classification"];

export default function TypingEffect2() {
  ...
  return (
    <div className="flex items-center justify-center">
      <h1 className="text-4xl font-bold text-[var(--color-P2)]">
        {text}
